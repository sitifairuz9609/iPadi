...
public class Percuma {
    ...
    public String getPercuma() {
        return percuma;
    }

    public void setPercuma(String percuma) {
    ...
    public Percuma(String percuma, String jenisaktiviti, String aktiviti, String item, String ukuran, String harga, String kuantiti, String id) {
        this.percuma = percuma;
        this.jenisaktiviti = jenisaktiviti;
        this.aktiviti = aktiviti;
        this.item = item;
